  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        ? BlocConsumer<ReporteTransferenciaStockBloc, ReporteTransferenciaStockState>(
            listener: (context, state) {
              if(state is ReporteTransferenciaStockDownloadSuccess){
                OpenFile.open(state.filePath);
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text('Reporte descargado en ${state.filePath}'),
                  backgroundColor: Colors.green,
                ));
              } else if (state is ReporteTransferenciaStockDownloadFailure) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            builder: (context, state) {
              if(state is ReporteTransferenciaStockLoading){
