...
class ReporteTransfereciaStockRepository {
  ...
  Future<String> downloadReport({
    ...
    try {
      ...
      final endpoint = tipoDocumento == 'transferencia_stock'
          ? 'transferenciastock/GenerarReporte'
          : 'solicitudtraslado/GenerarReporte';

      final uri = Uri.parse('$_baseUrl/$endpoint').replace(
        queryParameters: {
          'tipoDocumento': tipoDocumento,
          'docEntry': docEntry.toString(), // Convertir a String
        },
      );
      ...
      switch (response.statusCode) {
        case 200:
          ...
          final filePath = '${directory.path}/$tipoDocumento-$docEntry.pdf';
