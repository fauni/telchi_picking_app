...
class SolicitudTrasladoRepository {
  final String _baseUrl = Environment.UrlApi;
  final AuthRepository _authRepository = AuthRepository();
  
  Future<ApiResponseList<SolicitudTraslado>> obtenerSolicitudesTraslado(int pageNumber, int pageSize, {String? search, DateTime? docDate}) async {
    ...
    final url = Uri.parse('$_baseUrl/solicitudtraslado').replace(queryParameters: queryParams);
  ...
  Future<ApiResponse<SolicitudTraslado>> obtenerSolicitudTrasladoPorId(int id) async {
    final url = Uri.parse('$_baseUrl/solicitudtraslado/$id');
